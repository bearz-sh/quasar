...
export function test(name: string, options: Omit<ITestDefinition, 'name' | 'fn'>, fn: (t: ITestDefinition) => void) : void 
...
function when(condition: boolean, name: string, options: Omit<ITestDefinition, 'name' | 'fn' | 'ignore'>,  fn: (t: ITestContext) => void | Promise<void>) : void;
